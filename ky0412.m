...
%结束
% 
% hang_start=266;  %xw0411，去掉前10帧，通过
% hang_end=283;
% lie_start=351;                                                                                                                                                                                                                                                                                    00;
% lie_end=373;

% hang_start=338;  %20170329_飞行器，去掉前50帧，通过
% hang_end=358;
% lie_start=322;                                                                                                                                                                                                                                                                                    00;
% lie_end=342;
...
%  hang_start=336;  %xw0412，去掉前50帧，通过
%  hang_end=358;
%  lie_start=337;                                                                                                                                                                                                                                                                                    00;
%  lie_end=372;
...
%%
    ...
    if i==1
        ...
        if((length(pbb2)~=0)&&(YOUXIAO==1))  
            ...
            if (KUAN_4_MJC(i,:))<(MAXKUANG_4MJC)%小于之前最大的面积差
